...
Reservation workflow tests cover releasing stock, FIFO redistribution, transfer to a selected order, reload persistence, and automatic allocation when saving an order at 390 and 1440 px. Automatic allocation prioritizes the recorded order date; manual choices remain pinned until changed or returned to automatic mode.
